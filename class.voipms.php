<?php //hacked - add credentials, fix some missing parameters
class VoIPms{

    /*******************************************\
     *  VoIPms - API Credentials
    \*******************************************/
    var $api_username   = 'me@smymailserver.com';        // hacked - put yours here
    var $api_password   = '11aa1a1a-9999#9999-ffff-deafbeefaaaa'; //hacked - put yours here
...
// hacked - add missing parameters $folder and $message_num
...
// hacked - added missing final parameter $format
